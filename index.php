    ...
    <body>
        <div id="app">
            ...
            <div id="main">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Sistem Pendukung Keputusan Seleksi Calon Atlet Berbakat Terbaik</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <p class="card-text">
                                            Sistem ini membantu proses seleksi calon atlet berbakat terbaik menggunakan metode SAW (Simple Additive Weighting). Setiap kandidat dievaluasi berdasarkan kriteria seperti keterampilan teknis olahraga, kondisi fisik, prestasi akademik, disiplin latihan, dan usia. Hasil akhir berupa peringkat atlet terbaik yang layak dipilih.
                                        </p>
                                        <hr>
                                        <p class="card-text">
                ...
                <div class="dashboard-illustration-wrapper">
                    <img src="assets/images/sporty.jpg" alt="Sporty" class="dashboard-illustration">
                </div>
