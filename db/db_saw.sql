...
CREATE TABLE IF NOT EXISTS `saw_alternatives` (
  ...
  `biodata_pdf` varchar(255) DEFAULT NULL,
...
INSERT INTO `saw_alternatives` (`id_alternative`, `name`, `profile_photo`, `biodata_pdf`) VALUES
	(1, 'Andi Pratama', NULL, NULL),
	(2, 'Budi Santoso', NULL, NULL),
	(3, 'Citra Lestari', NULL, NULL),
	(4, 'Dewi Anggraini', NULL, NULL),
	(5, 'Eka Saputra', NULL, NULL),
	(6, 'Fajar Ramadhan', NULL, NULL),
	(7, 'Gita Permata', NULL, NULL),
	(8, 'Hendra Wijaya', NULL, NULL);
...
INSERT INTO `saw_criterias` (`id_criteria`, `criteria`, `weight`, `attribute`) VALUES
	(1, 'Keterampilan Teknis Olahraga', 3.0, 'benefit'),
	(2, 'Kondisi Fisik', 2.5, 'benefit'),
	(3, 'Prestasi Akademik', 1.5, 'benefit'),
	(4, 'Disiplin Latihan', 2.0, 'benefit'),
	(5, 'Usia', 1.0, 'cost');
